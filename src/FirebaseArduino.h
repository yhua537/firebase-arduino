...
class FirebaseArduino {
 public:
   ...
   */
  bool patch(const String &path, const JsonVariant &value);
  bool set(const String &path, const JsonVariant &value);
   ...
   */
  virtual bool stream(const String &path);
  ...
  virtual void readEventString(String &eventType, String &data);
 ...
 private:
  String host_;  //32
  //String testOfwaste_;
  //String testOfwaste2_;
  String auth_;          //32
  String tokenHost_;     //16
  String tokenPath_;     //0
  String refreshToken_;  //240
  String key_;           //32
  String loginHost_;
  String loginPath_;
  String user_;
  ...
  void initStream();
  void initRequest();
  int handleTokenError(bool isStream);
  int handleLoginError(bool isStream);
